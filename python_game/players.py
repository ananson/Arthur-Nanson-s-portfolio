...
Code qui prend en compte si les joueurs sont humains ou non et crée leur classe respective
"""
...
class MinimaxPlayer(AIPlayer):
    ...
    def play(self, event=None):
        ...
        self.new_board = copy.deepcopy(self.board.grid)
        self.new_offset = copy.deepcopy(self.board.offset)

        self.board.played_boards.append((self.new_board, self.new_offset))#sert a copier le board et l'offset apres le coup pour pouvoir les mettre dans les coups deja joues
